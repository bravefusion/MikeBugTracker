...
namespace MikeBugTracker.Controllers
{
    public class TicketPrioritiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,UserId,Description")] TicketPriorities ticketPriorities)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserId,Description")] TicketPriorities ticketPriorities)
        {
            if (ModelState.IsValid)
            {
